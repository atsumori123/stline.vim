function! themes#default#hi() abort
	...
	let bc07 = {"cterm" : "222", "gui" : "#505050"}

	let fc01 = {"cterm" : "27" , "gui" : "royalblue"}
	let fc02 = {"cterm" : "36" , "gui" : "mediumseagreen"}
	let fc03 = {"cterm" : "207", "gui" : "hotpink"}
	let fc04 = {"cterm" : "172", "gui" : "coral"}
	let fc05 = {"cterm" : "251", "gui" : "royalblue"}
	let fc06 = {"cterm" : "0"  , "gui" : "black"}
	let fc07 = {"cterm" : "134", "gui" : "lightskyblue"}


	let c2 = {"c" : "251", "g" : "#303030"}
	let c3 = {"c" : "207", "g" : "lightblue"}
	let c4 = {"c" : "17" , "g" : "midnightblue"}
	let c5 = {"c" : "235", "g" : "midnightblue"}
...
"	 +--------+--------+-----------------------------------------------+------------+-------------+-----+
	...
	" Statusline S2
	exec "highlight STLineS2 ".cg."bg=".bc06[cg]." ".cg."fg=".c101[cg]
